...
export default function ClientHeader() {
  ...
  return (
    <div>
      <nav className="p-2 background-color">
        <div className="container-fluid d-flex justify-content-between">
          ...
          {/* Trang chủ */}
          <a href="#" className="btn btn-outline-success me-2 text-nowrap d-none d-sm-block">
          ...
          <div className="d-flex align-items-center">
            <div className="me-2">
              <Link to="/Account/Login" className="btn btn-outline-success me-2 text-nowrap">
